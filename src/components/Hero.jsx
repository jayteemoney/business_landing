...
import { gradientLeft, gradientRight, gradientText } from '../others/stlyles';
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-3 bg-gradient-to-r from-[#1c1c1c] to-[#535353] bg-opacity-60 px-4 py-2 rounded-full w-max shadow-sm backdrop-blur-md">
              <div className="w-6 h-6 rounded-full bg-[#121212] flex items-center justify-center">
                <span className="ml-1 text-sm font-bold" style={gradientText}>%</span>
              </div>
              <p className="text-sm font-medium ml-1" style={gradientText}>
            ...
            <div className="flex items-center gap-4 mt-8 flex-wrap sm:flex-nowrap">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                The Next{" "}
                <span className="ml-1" style={gradientText}>Generation</span>
                <br />
                Payment Method
                <span className="ml-1" style={gradientText}>.</span>
              </h1>
